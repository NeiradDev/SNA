...
/**
 * ============================================================
 * Vista: Lista_usuario.php
 * Objetivo:
 * - Mostrar el listado de usuarios en una tabla Bootstrap + DataTables
 * - Permitir búsqueda, paginación y exportación (copy/excel/csv/pdf/print)
 * - Mostrar un modal de éxito cuando se registra un usuario (flashdata)
 * ============================================================
 */
?>
...
<?= $this->section('styles') ?>
<!-- ============================================================
     ESTILOS DataTables (Bootstrap 5 + Buttons + Responsive)
     ============================================================ -->
